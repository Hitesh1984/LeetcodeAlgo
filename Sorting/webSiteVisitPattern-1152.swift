//
//  webSiteVisitPattern-1172.swift
//  Code challenge
//
//  Created by Dave, Hiteshkumar on 5/9/25.
//
/*
 https://leetcode.com/problems/analyze-user-website-visit-pattern/description/?envType=company&envId=amazon&favoriteSlug=amazon-three-months
...
func mostVisitedPattern(_ username: [String], _ timestamp: [Int], _ website: [String]) -> [String] {
    ...
    func patternCount(_ user: String ,_ websites: [(String, Int)], _ start: Int) {
        if pattern.count == 3 {
            ...
            if start < websites.count {
                for index in start...websites.count-1 {
                    ...
                    patternCount(user, websites, index + 1)
                    pattern.removeLast()
                }
            }
        }
