//
//  minDeletionsForAtMostKDistCharacters-3545.swift
//  Code challenge
//
//  Created by Dave, Hiteshkumar on 7/12/25.
/*
 https://leetcode.com/problems/minimum-deletions-for-at-most-k-distinct-characters/description/?envType=company&envId=facebook&favoriteSlug=facebook-three-months
...
func minDeletion(_ s: String, _ k: Int) -> Int {
    ...
    let deletions = sortedFrequencies.suffix(from: k).reduce(0, +)
