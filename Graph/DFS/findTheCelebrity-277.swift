//
//  findTheCelebrity-277.swift
//  Code challenge
//
//  Created by Dave, Hiteshkumar on 5/13/25.
//
/*
 https://leetcode.com/problems/find-the-celebrity/description/?envType=company&envId=amazon&favoriteSlug=amazon-three-months
...
/*
 class Solution : Relation {
     func findCelebrity(_ n: Int) -> Int {
         ...
         func isCelebrity(_ candidate: Int) -> Bool {
             for people in 0..<n {
