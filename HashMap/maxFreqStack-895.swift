//
//  maxFreqStack-895.swift
//  Code challenge
//
//  Created by Dave, Hiteshkumar on 9/16/25.
/*
 https://leetcode.com/problems/maximum-frequency-stack/description/?envType=problem-list-v2&envId=hash-table
...
class FreqStack {
    ...
    func push(_ x: Int) {
        ...
        numFreq[x] = freq
        freqNums[freq, default: [Int]()].append(x)
    ...
    func pop() -> Int {
        ...
        if freqNums[maxFreq, default: [Int]()].isEmpty { maxFreq -= 1 }
        return num
    }
}
